package ru.agcon.library_app.config;
...
@Configuration
@ComponentScan("ru.agcon.library_app")
@PropertySource("classpath:application.properties")
@EnableTransactionManagement
@EnableJpaRepositories("ru.agcon.library_app.repositories")
@EnableWebMvc
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.agcon.library_app.models");
